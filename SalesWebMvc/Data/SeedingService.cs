...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 8, 12), 1000, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1958, 11, 5), 1000, d3);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1945, 3, 8), 1000, d2);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1984, 5, 15), 1000, d1);
            Seller s6 = new Seller(6, "Alex Pink", "alexPink@gmail.com", new DateTime(1973, 6, 10), 1000, d4);
